...
const photos = [
  { src: '/m.mind/concerto.jpg', alt: 'Concierto en vivo' },
  { src: '/m.mind/sesion.jpg', alt: 'Sesión de fotos' },
...
const videos = [
  ...
  { title: 'Lluvia de Noviembre - Live Session', thumbnail: '/m.mind/lluvia.jpg', duration: '3:45' },
